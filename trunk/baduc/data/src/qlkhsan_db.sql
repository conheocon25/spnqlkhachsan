...
--
-- Table structure for table `baduc_paid_employee`
--
...
--
-- Dumping data for table `baduc_paid_employee`
--
...
--
-- Table structure for table `baduc_type_room`
--
...
--
-- Constraints for table `baduc_paid_employee`
--
