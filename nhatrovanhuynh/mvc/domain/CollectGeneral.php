...
class CollectGeneral extends Object{
	...
	function getURLUpdLoad(){
		return "/collect/general/".$this->getIdTerm()."/".$this->getId()."/upd/load";
	}
	function getURLUpdExe(){		
		return "/collect/general/".$this->getIdTerm()."/".$this->getId()."/upd/exe";
	}
	
	function getURLDelLoad(){		
		return "/collect/general/".$this->getIdTerm()."/".$this->getId()."/del/load";
	}
	function getURLDelExe(){		
		return "/collect/general/".$this->getIdTerm()."/".$this->getId()."/del/exe";
	}
}
?>