...
class Tracking extends Object{
	...
	function getPathFileLog(){$Log = "data/log/".\date("m-Y", strtotime($this->getDateStart()));return $Log.".log";}
	...
	function isCurrent(){
		$date1 = date('m-Y', time());
		$date2 = date('m-Y', strtotime($this->DateStart));		
		if ($date1==$date2)
			return true;
	...
	function getURLLogExe(){return "/report/".$this->getId()."/log/exe";}
